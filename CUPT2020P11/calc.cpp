...
speckle::speckle(long rayNuma, double xa, double rayYMAXa, double rayYMINa, double rayZMAXa, double rayZMINa, long solutionXa, long solutionYa)
{
	rayNum = rayNuma;
	rayYMAX = rayYMAXa;
	rayYMIN = rayYMINa;
